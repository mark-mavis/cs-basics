...
namespace class_example
{
    public class PersonClass
    {
        ...
        public string EyeColor
        {
            get
            {
                if (_eyecolor != null) return _eyecolor;
                return "unknown";
            }
            set { _eyecolor = value; }
        }
        ...
        {
            _name = "unknownName";
            _eyecolor = "unknownEyeColor";
        }
        public PersonClass(string name, string eyecolor)
        {
            _name = name;
            _eyecolor = eyecolor;
        }
    ...
    class Program
    {
        public static void Run()
        {
            PersonClass person1 = new PersonClass("Mark", "Mavis");
